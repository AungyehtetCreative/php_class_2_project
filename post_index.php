    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    <a href="!#"><img class="card-img-top" src="actions/post_photo/<?php echo $row['file_name']; ?>"
                            alt="..." /></a>
                    <div class="card-body">
                        <div class="small text-muted">
                            <?php echo date("F j, Y", strtotime($row['created_at'])); ?> || <?= time_Ago(($row['created_at'])); ?> <span class="float-end">
                                <h4>Posted by: <?= $row['name'] ?></h4>
                            </span>
                        </div>
                        <h6 class="card-title">Post Category : <?= $row['cat_name']; ?></h6>
                        <h2 class="card-title">Post Title: <?= $row['title']; ?></h2>
                        <p class="card-text"><?php echo substr($row['description'], 0, 100); ?></p>
                        <a href="post_detail.php?id=<?= $row['id']; ?>" class="btn btn-outline-primary">Read
                            More</a>
                    </div>
                </div>
                <?php endwhile; ?>
                ...
                <div class="text-center">
                    <ul class="pagination justify-content-center mb-4">
                        ...
                        ?>
                        <li class="page-item">
                         <a class="pagee-link" href="post_index.php?page=<?= $i; ?>"><?= $i ?></a>
                        </li>
                        <?php endfor; ?>
                        <li class="page-item">
